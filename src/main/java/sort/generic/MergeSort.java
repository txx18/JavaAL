...
public class MergeSort<T extends Comparable<T>> extends AbstractSort<T> {
    ...
    public void sort(T[] a) {
        ...
        // 不能new Object [Ljava.lang.Object; cannot be cast to [Ljava.lang.Comparable;
        this.help = ((T[]) new Comparable[a.length]);
...
//        bottomUp(a);
     ...
     * @param r
     */
    private void topDownRecur(T[] a, int l, int r) {
        if (l >= r) {
            return;
        }
        int mid = l + ((r - l) >> 1);
