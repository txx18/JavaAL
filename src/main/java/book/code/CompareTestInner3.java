...
import book.code.weiss.util.Comparator;
...
class CompareTestInner3
{
    ...
    public static void main( String [ ] args )
    {
        ...
        System.out.println( "MAX WIDTH: " + findMax( rects, new Comparator<SimpleRectangle>( )
            {
        ...
        System.out.println( "MAX AREA: " + findMax( rects, new Comparator<SimpleRectangle>( )    
            {
                public int compare( SimpleRectangle r1, SimpleRectangle r2 )
                {
